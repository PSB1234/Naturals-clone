        ...
        <nav>
          <div className="bg-[#39393F] text-white lg:block hidden h-12 w-full">
            <ul className="flex flex-row justify-center gap-5 pt-3">
              ...
              <li onClick={Burger} className="flex overflow-hidden  gap-2 hover:cursor-pointer group hover:text-[#00AC4E]">
                Products
                ...
                {isOpen && (<div className="absolute top-[10rem] duration-700 left-[22rem] bg-white z-[999] ">
                  <ul  className="duration-700 grid grid-cols-3 delay-700 p-8 gap-5 text-black text-center">
                    <li >
                      <a className="flex justify-center" href="#">
                        <img className="hover:cursor-pointer duration-700 hover:scale-125"
                          src={RoundTheYear}
                          alt="Round The Year"
                        />
                      </a>
